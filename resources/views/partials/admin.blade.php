        ...
        <footer class="sticky-footer bg-white">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span>Copyright &copy; Dishub 2023</span>
            </div>
          </div>
        </footer>
        <!-- End of Footer -->
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Ingin Meninggalkan Laman?</h5>
            <button
              class="close"
              type="button"
              data-dismiss="modal"
          ...
          <div class="modal-body">
            Tekan "Logout" dibawah untuk  meninggalkan laman.
          </div>
